...
*/
        ...
        #region 关注/取消（订阅请求重写）
            ...
            {
                JULONG.CAFTS.Model.Weixin.WeixinDBHelper.AddAccount(requestMessage.FromUserName);

                return base.OnEvent_ScanRequest(requestMessage);
            }
            public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
            {
                var result = JULONG.CAFTS.Model.Weixin.WeixinDBHelper.AddAccount(requestMessage.FromUserName);
            ...
            {
                var result = JULONG.CAFTS.Model.Weixin.WeixinDBHelper.CancelAttend(requestMessage.FromUserName);
