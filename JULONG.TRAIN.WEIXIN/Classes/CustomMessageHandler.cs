...
namespace JULONG.TRAIN.WEIXIN.Classes
{
    ...
    {
        /*
         * 重要提示：v1.5起，MessageHandler提供了一个
         * 
         * 
         * 的抽象方法，
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            #region Senparc调试
             //OnTextRequest_Senparc调试(requestMessage,ref responseMessage);
            #endregion
...
*/
        ...
        public override IResponseMessageBase OnEvent_ClickRequest(RequestMessageEvent_Click requestMessage)
        {
            ...
            //菜单点击，需要跟创建菜单时的Key匹配
            //JULONG.CAFTS.Weixin.Models.BaseDBContext db = new Models.BaseDBContext();
            //WxArtcle wa = db.WxArtcle.FirstOrDefault(d => d.Name == requestMessage.EventKey);
        ...
        #region 关注/取消（订阅请求重写）
            ...
            {
                JULONG.TRAIN.Model.WeixinDBHelper.AddAccount(requestMessage.FromUserName);

                return base.OnEvent_ScanRequest(requestMessage);
            }
            public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
            {
                var result = JULONG.TRAIN.Model.WeixinDBHelper.AddAccount(requestMessage.FromUserName);

 	            //return base.OnEvent_SubscribeRequest(requestMessage);
                var responseMessage = this.CreateResponseMessage<ResponseMessageText>();
                responseMessage.Content = "欢迎关注聚龙反假货币培训服务 官方微信";
                return responseMessage;
            }
            //取消关注
            public override IResponseMessageBase OnEvent_UnsubscribeRequest(RequestMessageEvent_Unsubscribe requestMessage)
            {
                var result = JULONG.TRAIN.Model.WeixinDBHelper.CancelAttend(requestMessage.FromUserName);
