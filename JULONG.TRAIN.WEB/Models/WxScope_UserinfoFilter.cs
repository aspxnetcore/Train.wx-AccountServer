...
namespace JULONG.TRAIN.WEB.Models
{
    ...
    public class WxScope_UserinfoFilter : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (sa==null || String.IsNullOrWhiteSpace(sa.openid) || !AccountHelper.WxIsAttendByDB(sa.openid)) 
            {//无session openid
                ...
                var url = Senparc.Weixin.MP.AdvancedAPIs.OAuthApi.GetAuthorizeUrl(Config.WX_AppId, redirectUrl, "getUserInfo", Senparc.Weixin.MP.OAuthScope.snsapi_userinfo);
